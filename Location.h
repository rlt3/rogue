...
bool locations_adjacent(Location l1, Location l2) {
  Location l1_center = {l1.x + 32, l1.y + 32};
  Location l2_center = {l2.x + 32, l2.y + 32};

  Location diff = subtract_locations(l1_center, l2_center);
